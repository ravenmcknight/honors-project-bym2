...
age18to34 <- paste0("estimate_B01001_", c("007", "008", "009", "010", "011", "012",
...
agecohorts2$age18to34 <- rowSums(agecohorts2[, ..age18to34])
...
agecohorts <- agecohorts2[, `:=`(genz = genz/summary_est, millenial = millenial/summary_est, 
                                 ...
                                 age18to34 = age18to34/summary_est)]
agecohorts <- agecohorts[, under40 := genz + millenial]
agecohorts <- agecohorts[, .(year, GEOID, summary_est, genz, millenial, genx, boomer, under40, age18to34)]
