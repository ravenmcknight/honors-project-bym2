...
avl_query <- paste0("
                    ...
                    LEFT JOIN DIM_STOP
                    on DIM_STOP.stopsk = a.stopsk
                    WHERE date_key BETWEEN 20200327 AND 20200926
                    ")
...
apc_query <- paste0(" 
                    ...
                    LEFT JOIN DIM_STOP s
                    on s.STOPSK = a.STOPSK
                    WHERE a.date_key BETWEEN 20200327 AND 20200926
                    ")
...
## CHANGE COVID/2019 DEPENDING ON DATA PULL
saveRDS(apc, 'data/covid/raw/apc.RDS')
saveRDS(trips, 'data/covid/raw/trips.RDS')
saveRDS(picks, 'data/covid/raw/picks.RDS')