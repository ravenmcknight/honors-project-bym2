...
lm_dat <- readRDS('/Users/raven/Documents/honors/honors-project/data/modeling-dat/lm_dat_scaled.RDS')
```
...
lm1 <- lm(scale(log_daily_boards) ~ pop_density + emp_density + perc_no_veh + walkability + scale(log_daily_stops), lm_dat, na.action = na.exclude)
...
ggplot(lm_dat, aes(x=scale(log_daily_boards), y = predicted_log_scale_boards)) +
  geom_point() +
